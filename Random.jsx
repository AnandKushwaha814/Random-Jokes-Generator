...
const Random = () => {
    ...
    // if data is not fetch the show loading...
            ...
            {randomJokes && (
                <>
                    <div className="flex justify-center items-center">
                        <div className='grid grid-flow-row bg-slate-700 rounded shadow-lg p-4 hidden'>
                            <h2 className='p-2 m-4 text-2xl text-center font-bold text-white bg-slate-500 rounded'>Jokes😆</h2>
                            <p className='p-4 bg-slate-700 m-4 rounded text-white font-bold bg-fixed hidden'>{randomJokes.setup}</p>
                            <p className='p-4 bg-slate-700 m-4 rounded text-white font-bold bg-fixed hidden'>{randomJokes.punchline}</p>
